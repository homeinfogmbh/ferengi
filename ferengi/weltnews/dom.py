...
# Generated 2023-08-22 11:21:48.721813 by PyXB version 1.2.7-DEV using Python 3.11.3.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:52398c58-40cd-11ee-a374-a8a159b886ae')
...
class News (pyxb.binding.basis.complexTypeDefinition):
    ...
    __id = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'id'), 'id', '__AbsentNamespace0_News_id', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 39, 12), )
    ...
    __subline = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'subline'), 'subline', '__AbsentNamespace0_News_subline', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 46, 12), )
    ...
    __headline = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'headline'), 'headline', '__AbsentNamespace0_News_headline', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 53, 12), )
    ...
    __source = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'source'), 'source', '__AbsentNamespace0_News_source', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 60, 12), )
    ...
    __textmessage = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'textmessage'), 'textmessage', '__AbsentNamespace0_News_textmessage', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 67, 12), )
    ...
    __published = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'published'), 'published', '__AbsentNamespace0_News_published', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 74, 12), )
    ...
    __image = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'image'), 'image', '__AbsentNamespace0_News_image', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 81, 12), )
    ...
    __thumb = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'thumb'), 'thumb', '__AbsentNamespace0_News_thumb', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 88, 12), )
    ...
    __video = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'video'), 'video', '__AbsentNamespace0_News_video', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 95, 12), )
    ...
    __webUrl = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'webUrl'), 'webUrl', '__AbsentNamespace0_News_webUrl', False, pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 102, 12), )
...
class TypedString (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 113, 4)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 121, 16)
    __type._UseLocation = pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 121, 16)
...
News._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'id'), pyxb.binding.datatypes.nonNegativeInteger, scope=News, documentation='\n                        Identifikationsnummer\n                    ', location=pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 39, 12)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 81, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 88, 12))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 95, 12))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 102, 12))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'id')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 39, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'subline')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 46, 12))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'headline')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 53, 12))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'source')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 60, 12))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'textmessage')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 67, 12))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'published')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 74, 12))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'image')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 81, 12))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'thumb')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 88, 12))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'video')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 95, 12))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(News._UseForTag(pyxb.namespace.ExpandedName(None, 'webUrl')), pyxb.utils.utility.Location('/home/neumann/Projekte/ferengi/xsds/welt.xsd', 102, 12))
