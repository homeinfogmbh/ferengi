...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:1fc5e212-463c-11ed-95d3-7427eaa9df7d"
)
...
class TypedString(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/ferengi/xsds/welt.xsd", 106, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/ferengi/xsds/welt.xsd", 114, 16
    )
...
def _BuildAutomaton_():
    ...
    transitions = []
    transitions.append(fac.Transition(st_7, [fac.UpdateInstruction(cc_2, True)]))
