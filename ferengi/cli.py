...
from ferengi.rssapp import update as update_rss_app
...
def get_args() -> Namespace:
    ...
    parser.add_argument("-f", "--force", action="store_true", help="force data import")
    parser.add_argument(
    ...
    subparsers.add_parser("rssapp", help="import news from rss.app")
