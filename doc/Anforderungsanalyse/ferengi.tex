...
%	\emph{F.E.R.E.N.G.I.} soll in der Lage sein, die o.g. Schnittstellen automatisch für jeden Benutzer anzusprechen und lokal die Immobiliendaten im \emph{Openimmo}-Format in der \emph{Version 1.2.6}. zu hinterlegen. Darüber hinaus soll es möglich sein die Immobiliendaten der Kunden nach dem Import, bzw. vor dem Export über reguläre Ausdrücke zu modifizieren. Auch soll \emph{H.O.M.I.E.} QR-Codes für Mobil-Exposés generieren und veröffentlichen können. 
